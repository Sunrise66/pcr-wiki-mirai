...
public class DivideAction extends ActionParameter {
    ...
    public String localizedDetail(int level, Property property) {
        if(actionValue1 == 0)
            return I18N.getString("Modifier_multiple_s1_HP_max_HP_to_value_d2_of_effect_d3",
            ...
            return I18N.getString("Modifier_multiple_s1_lost_HP_max_HP_to_value_d2_of_effect_d3",
                    buildExpression(level, null, RoundingMode.UNNECESSARY, property, false, false, true),
                    actionDetail2, actionDetail1 % 10);
        else if(actionValue1 == 2)
            return I18N.getString("Modifier_multiple_s1_count_of_defeated_enemies_to_value_d2_of_effect_d3",
                    buildExpression(level, null, RoundingMode.UNNECESSARY, property, false, false, true),
                    actionDetail2, actionDetail1 % 10);
        else if(actionValue1 >= 200 && actionValue1 < 300)
            return I18N.getString("Modifier_multiple_s1_stacks_of_mark_ID_d2_to_value_d3_of_effect_d4",
                    buildExpression(level, null, RoundingMode.UNNECESSARY, property, false, false, true),
