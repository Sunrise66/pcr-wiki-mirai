...
public class ActionParameter {
    ...
    public String localizedDetail(int level, Property property){
        return I18N.getString("Unknown_effect_d1_to_s2_with_details_s3_values_s4",
                rawActionType,
    ...
    public String buildExpression(int level,
        ...
        if(Statics.EXPRESSION_STYLE && !isEnemySkill){
            ...
            for(ActionValue value : actionValues){
                ...
                if(value.initial != null && value.perLevel != null) {
                    ...
                    if(initialValue == 0 && perLevelValue == 0) {
                        ...
                        part.append(String.format("%s * %s", perLevelValue, I18N.getString("SLv")));
                        ...
                        part.append(String.format("%s + %s * %s", initialValue, perLevelValue, I18N.getString("SLv")));
                    }
                    if(value.key != null){
                         if(initialValue == 0 && perLevelValue == 0){
                             continue;
...
enum ClassModifier{
    ...
    public String description(){
        switch (this){
            case magical:
                return I18N.getString("magical");
            case physical:
                return I18N.getString("physical");
            case inevitablePhysical:
                return I18N.getString("inevitable_physical");
            default:
